...
To guarantee data consistency a backup and a log file are used. The backup stores a snapshot of the state of the Hash table, while the log stores all write and delete commands made since startup.
