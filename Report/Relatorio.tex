...
The Data storage is implemented on an Hash Table where each bucket of the hash table is a linked list and each list entry holds the key and a pointer to the Value .

The Hash table was implemented abstracting from the Value implementation, the hash is defined in a structure, Figure ? .
